...
<div class="main-w3layouts" id="home">
	...
	<div class="top-search-bar" style="position:fixed;">
	<div class="logo">  <img src="images/logo1.jpg"  style="width:90px; height:50px;" /></div>
	...
	<!-- Modal4 -->
		<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" >
			...
			<div class="clearfix"></div>
	<!-- //Modal4-->
				<div class="search" style="margin-top:-11px;">
						<form action="#" method="post">
	...
	<!--//top-bar-->
	<!-- navigation -->
			<div class ="top-nav" style="margin-top:-11px;">
				<nav class="navbar navbar-default" >
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"  >
							<ul class="nav navbar-nav navbar-right">
								<li><a href="index.jsp" class="hvr-underline-from-center active">Home</a></li>
...
<div class="w3-content w3-section" style="max-width:1800px">
  <img class="mySlides" src="images/slide2.jpg" style="width:100%;height:600px;" >
    <img class="mySlides" src="images/e.jpg" style="width:100%;height:600px;" >
    <img class="mySlides" src="images/g.jpg" style="width:100%;height:600px;" >
   <img class="mySlides" src="images/slide1.jpg" style="width:100%;height:600px;" >
  <img class="mySlides" src="images/slide3.jpg" style="width:100%;height:600px;">
...
{
%>
<h1 style="color:red;font-size:200%;margin-left:35%;margin-top:-30%;position:fixed;"><%=str %></h1>
<% 
}
%>
...
<div id="about" class="about">
	<div class="container">
			...
			<h2><b> WALK2CAREER <b> is a learning system where you will get all content, content regarding B.Tech,Placement Preparation and for Gate aspirants as well This website is designed in such a way to meet all requirements of a B.Tech undergraduate and graduate students.</h2>
			<div class="specialty-grids-top">
				...
				<div class="col-md-4 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<p> The online classes will serve you with a platform to explore yourself and saving tour time as well.</p>
				</div>
				<div class="col-md-4 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<figure class="icon">
					...
					<p> We provide you with our best teaching facilities, complete study material & our experts as well for any queries.</p>
				</div>
	...
	<div class="about-info">
		...
		<div class="right-agile">
			<h5 style="color:#333333">WALK</h5>
			<p> Walk Up & take a step. Passion is what gives meaning to our lives.</p>
			<h5 style="color:#333333"> TO</h5>
			<p> Take a step for brighter career, towards your goal and we'll guide you at our best.</p>
			<h5 style="color:#333333">CAREER</h5>
			<p>Career is what you make by your efforts. So, put your efforts and give us opportunity to guide for your way. </p>
		</div>
	</div>
	<div class="clearfix"></div>
<!--//about-->
...
<div class="services" id="services">
		...
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			...
			<h4>Service 2</h4>
			<p>STUDY MATERIAL FOR B.TECH STUDENTS</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
			...
			<h4>Service 3</h4>
			<p>STUDY MATERIAL FOR PLACEMENT PREPARATION</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
			...
			<h4>Service 4</h4>
			<p>  STUDY MATERIAL FOR GATE ASPIRANTS </p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
			...
			<h4>Service 5</h4>
			<p> COMMUNICATION WITH EXPERTS FOR QUERIES</p>
		</div>
		<div class="clearfix"> </div>
</div>
...
<div class="team" id="team" >
	<div class="container" >
		...
		<div class="team_gds" >
			<div class="col-md-3 team_gd1 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s" style="width:20%">
				<div class="team_pos">
					<div class="team_back"></div>
					<img class="img-responsive" src="images/abhay.jpg"  style="width:200px;height:230px" alt=" " >
					<div class="team_info">
						<a href="https://www.facebook.com/abhay.gill2"  class="face_one"><i class=" so1 fa fa-facebook fc1" aria-hidden="true"></i></a>
						<a href="https://twitter.com/AbhayGill007"  class="face_one"><i class=" so2 fa fa-twitter fc2" aria-hidden="true"></i></a>
						<a href="https://plus.google.com/u/0/114695299276194971791"  class="face_one"><i class=" so3 fa fa-google fc3" aria-hidden="true"></i></a>
					</div>
				</div>
				<h4>ABHAY SINGH</h4>
			...
			<div class="col-md-3 team_gd1 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s" style="width:20%">
				<div class="team_pos">
					<div class="team_back"></div>
					<img class="img-responsive" src="images/ritz.jpg"  style="width:200px;height:230px" alt=" ">
					<div class="team_info">
	...
	<div class="footer" id="footer">
		<div class="container">
			<div class="col-md-4 agileinfo_footer_grid">
				<h4>About Us</h4>
				<p><b> WALK2CAREER <b> is a learning system where you will get all content, content regarding B.Tech,Placement Preparation and for Gate aspirants as well This website is designed in such a way to meet all requirements of a B.Tech undergraduate and graduate students.</span></p>
			</div>
			...
			<div class="col-md-4 agileinfo_footer_grid">
				<h4>Address</h4>
				<ul>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> NIET, Greater Noida</li>
					<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:info@example.com">gillabhay7@gmail.com</a></li>
					<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> +91 801082787</li>
				</ul>
			</div>
